...
- Peak peaking: peak peaking fins the peaks on the spectra and centroids them
...
This next chunk is only useful if you want to change the order of the images on the peak matrix. It can be skipped if your images are already on the order you want.
```{r}
