...
compClus <- 4   # Choose the cluster from the image you want to use as comparison 
norm <- peakM$normalizations$TIC  # Input here a vector with the normalization values. Input NA for no normalization.
...
This next chunk creates a volcano plot with x = log2(Fold Change) and y = -log10(p-values) and some lines marking the p-value = 0.05 and the Fold Change = 2.
```{r}

volcanoPlotJ(sumDataComp)
