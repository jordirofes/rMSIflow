...
img2plot <- 1          # Writing a vector c() allows you to plot more images at the same time. Input a 0 to plot all the                        # images in a non interactive way
normalization <- peakM$normalizations$TIC  # Input here a vector with the normalization values. Input NA for no 
                                           # normalization.
...
kmeansData <- kmeansCluster(peakM, data2clus, norm4, numClusters)
