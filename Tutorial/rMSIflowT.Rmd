...
ggplotly(initialPlotter(peakM, matrixList, mz2plot,img2plot, normalization, savePlot, fileN))
```
...
data2comp <- avSpecComp(peakM$intensity[refpixels,], peakM$intensity[comppixels,], peakM, norm)
```
...
impMz <- impData(data2plot, pvThreshold, fdThreshold)
plotVolcano <-volcanoPlotJ(data2plot, pvThreshold, fdThreshold)
